...
class HeroDataSource {
    ...
    val page1 get() = _page1
    val page2 get() = _page2
    val page3 get() = _page3
    val page4 get() = _page4
    val page5 get() = _page5

    private var _allHeroes = _page1 + _page2 + _page3 + _page4 + _page5
    val allHerroes get() = _allHeroes
